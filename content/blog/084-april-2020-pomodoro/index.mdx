...
import PomodoroDonut from './PomodoroDonut.js'
...
- Added [Algolia's search](/082-Algolia-install/) on my blog and learned about [debouncing](/083-debouncing-algolia/) for my search
- Completed a Book: The Name of the Wind by Patrick Rothfuss
- Created an fullstack online board game over the weekend, pair programming with my friend - [notcodenames](https://notcodenames.com/) - Upcoming post coming soon!


## <center> Reflection </center>

One more Pomodoro away from hitting my all time high of 124 Pomodoro's! Now that I am using a different Pomodoro tracking service, I started exporting my data in Excel and use the pivot tables to generate my data. MDX allows me to install React Components in Markdown files.
...
I completed the React Bootcamp and quickly realized that near the end of the course, I felt like the material I studied became outdated with the recent introduction of React Hooks which my knowledge is currently lacking.
...
I'm still hesitant on applying, I feel like I have so much to learn, my algorithms and data aren't so great but at the same time I haven't come across interviews yet that required it for a front-end developer.

This monthly reflection defintely shows that I haven't been putting in enough work on algorithms and data structures, about only 4.1% of my time has been spent there.

I hoped to have this up by 30% by the end of next month and at the same time working on my applications for any job openings. However, this pandemic proves it to be very difficult. Perhaps I need to try a different approach and reach out to a recruiter.
