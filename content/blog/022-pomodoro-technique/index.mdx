...
When doing the Pomodoro Technique, wind the timer when you \\*\\*feel ready\\_\\_ and in the \\*\\*right mood.\\_\\_ The Pomodoro Technique might not be for everyone, but I highly recommend it for those who need to find a way to stay productive. You might fall into two categories below which Steffan outlines in the book:
