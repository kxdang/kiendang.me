...
After 3 hours of tinkering, I finally got it to work! My <a href="https://github.com/kxdang/kiendang.me/commit/aa7a4cd9b7802e8ae8205a873ce1e9fe348e0df3#diff-ca94906dec2dec0df15659daa3b08a63" target="_blank">code comparison</a> on how I managed to switch over to MDX, a reference for those using existing gatsby-starter-blog and have already established multiple posts and added plugins. I had to work backwards and uninstall the plugins that had a different set up for MDX files, eventually in the near future I plan on posting my blog as a template with all the features I've installed
