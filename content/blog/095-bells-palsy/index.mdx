...
<center> <h1><Emojione text="🏥 The Hospital"/></h1></center>
...
<p style={{paddingTop: `2rem`, paddingBottom: `2rem`, marginTop: `3rem`, marginBottom: `3rem`,borderTop: `1px dashed`, borderBottom: `1px dashed`, textAlign:`center`}}>
    <p style={{fontSize: `3rem`, marginBottom: `0`}}><Emojione text="🧠"/></p>
    <br/>
...
<li><strong>Me:</strong> "I accidentally took 3 of the 1000mg Valtrex at once, will I be okay? <span style="font-size: 1.2rem"><Emojione text="😐"/></span>"</li>
<li><b style={{color: `#FF5370`}}>Phamacist:</b> "...<span style="font-size: 1.2rem"><Emojione text="😶"/></span>" </li>
...
<li><strong>Me:</strong> "Okay thanks, bye <span style="font-size: 1.2rem"><Emojione text="😅"/></span>"</li>
</ul>
